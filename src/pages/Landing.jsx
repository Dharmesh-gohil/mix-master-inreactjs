...
// we want to execute query two place in component and
//loader so we make it a function so it is useful for data redundency
...
// by adding queryClient we loader is function  that grab queryClient and that return another
//function and it is loader
export const loader =
  (queryClient) =>
  async ({ request }) => {
...
const Landing = () => {
  ...
  //this is first place we execute useQuery
